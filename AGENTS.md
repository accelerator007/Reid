...
- Local verification passes: 131/131 unit/contract/design-token tests, Production TypeScript/Vite build, and 10/10 public Chromium workflows. The browser suite explicitly verifies that WhatsApp is absent on open and appears only after the visitor requests a person. The Edge Function and frontend are not Production-live until the normal Staging and Owner-approved Production gates complete.
