...
-- The generic audit log already records project deletion. The project activity
-- feed cannot receive a child row after its parent project has been deleted;
-- attempting that made project deletion fail with a foreign-key violation.
